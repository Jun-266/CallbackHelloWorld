...
{
    default void callbackClient()
    {
        callbackClient(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void callbackClient(java.util.Map<String, String> context)
    {
        _iceI_callbackClientAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> callbackClientAsync()
    {
        return _iceI_callbackClientAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> callbackClientAsync(java.util.Map<String, String> context)
    {
        return _iceI_callbackClientAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_callbackClientAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "callbackClient", null, sync, null);
