...
{
    default Response printString(String s, CallbackPrx callback)
    {
        return printString(s, callback, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Response printString(String s, CallbackPrx callback, java.util.Map<String, String> context)
    {
        return _iceI_printStringAsync(s, callback, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Response> printStringAsync(String s, CallbackPrx callback)
    {
        return _iceI_printStringAsync(s, callback, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Response> printStringAsync(String s, CallbackPrx callback, java.util.Map<String, String> context)
    {
        return _iceI_printStringAsync(s, callback, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Response> _iceI_printStringAsync(String iceP_s, CallbackPrx iceP_callback, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Response> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "printString", null, sync, null);
